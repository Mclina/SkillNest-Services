            ...
            rounded-lg flex items-center gap-3'>
                ...
                <div className='mt-3 flex-col flex gap-1 items-baseline'>
                    <h2 className='text-[10px] bg-orange-100 p-1 rounded-full px-2
                     text-primary'>{business.documentId.categories?.data[0]?.documentId?.Name}</h2>
                <h2 className='font-medium text-sm'>{business.documentId.Name}</h2>
                <h2 className='text-primary text-xs flex gap-2'>
                    {/* <GraduationCap/> */}
                    {business .documentId.Year_of_Experience}</h2>
                    </div>
            </Link>
        ))}
    </div>
