  ...
  return (
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 border-[1px] p-5 mt-5 rounded-lg'>
          ...
          <div className='col-span-2 mt-5 flex md:px-10 flex-col gap-3 items-baseline'>
                <h2 className='font-bold text-2xl'>{business.attributes?.Name}</h2>
                <h2 className='flex gap-2 text-gray-500 text-md'>
                    <GraduationCap/>
                    <span>{business.attributes?.Year_of_Experience} of Experience</span>
                </h2>
                <h2 className='text-md flex gap-2 text-gray-500'>
                    <MapPin/>
                    <span>{business.attributes.Address}</span>
                </h2>
                ...
                <BookAppointment business={business} />
          </div>
         ...
         <p className='text-gray-500 tracking-wide mt-2'>{business.attributes.About}</p>
       </div>
       </>
  )
}
