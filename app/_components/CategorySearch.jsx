    ...
    return (
      <div className='mb-10 items-center px-5 flex flex-col gap-2'>
          ...
          text-4xl tracking-wide'>
              Search <span className='text-primary'>Businesss</span></h2>
          <h2 className='text-gray-500 text-xl'>Search and Book Appointment in one click</h2>
        ...
        <Button type="submit">
          ...
          {categoryList.length>0?categoryList.map((item,index)=>index<6&&(
            ...
            p-5 bg-orange-50 m-2 rounded-lg cursor-pointer
